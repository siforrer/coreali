# -*- coding: utf-8 -*-
"""
Created on Wed Mar 17 16:09:37 2021
...
"""
    ...
    def test_selectable(self):
        ...
        selector = Selector();
        test_reg_desc.AnotherAddrmap.ARepeatedReg[2]._construct_selector(selector.selected)
        self.assertEqual(selector.selected, [0, 0, 2])
        
        test_reg_desc.AnotherAddrmap.ARepeatedReg[2]._set_current_idx(selector.selected)
        self.assertEqual(test_reg_desc.AnotherAddrmap.ARepeatedReg.node.current_idx,[2])
        self.assertEqual(test_reg_desc.AnotherAddrmap.ARepeatedReg.node.parent.current_idx,[0])
        self.assertEqual(test_reg_desc.AnotherAddrmap.ARepeatedReg.node.parent.parent.current_idx,[0])
    ...
    def test_selectable_with_slice(self):
        ...
        selector = Selector();
        test_reg_desc.AnAddrmap.ARegfile.ARegInARegFile._construct_selector(selector.selected)
        self.assertEqual(selector.selected, [0, 0, slice(0, 2, 1), slice(0, 4, 1)])

        selector = Selector();
        test_reg_desc.AnAddrmap.ARegfile[0].ARegInARegFile[0:3:2]._construct_selector(selector.selected)
        self.assertEqual(selector.selected, [0, 0, 0, slice(0, 3, 2)])
        
        selector = Selector();
        test_reg_desc.AnAddrmap.ARegfile[0].ARegInARegFile[2]._construct_selector(selector.selected)
        self.assertEqual(selector.selected, [0, 0, 0, 2])
        
        selector = Selector();
        test_reg_desc.AnotherAddrmap.TenRegs[2:7:2]._construct_selector(selector.selected)
